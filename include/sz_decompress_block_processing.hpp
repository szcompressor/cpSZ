...
template<typename T>
inline void
block_pred_and_decompress_regression_2d_with_buffer(const float * reg_params_pos, T * buffer, double precision, int intv_radius, 
	int size_x, int size_y, size_t buffer_dim0_offset, size_t dim0_offset, const int *& type_pos, const T *& unpredictable_data_pos, T * dec_data_pos){
...
template<typename T>
inline void
block_pred_and_decompress_lorenzo_2d(const meanInfo<T>& mean_info, T * buffer, double precision, int intv_radius, 
	int size_x, int size_y, size_t buffer_dim0_offset, size_t dim0_offset, const int *& type_pos, const T *& unpredictable_data_pos, T * dec_data_pos){
	T * cur_data_pos = dec_data_pos;
	T * buffer_pos = buffer + buffer_dim0_offset + 1;
	for(int i=0; i<size_x; i++){
...
template<typename T>
inline void
block_pred_and_decompress_regression_2d_with_buffer_with_eb(const float * reg_params_pos, T * buffer, const double * precision_pos, int intv_radius, 
	int size_x, int size_y, size_t buffer_dim0_offset, size_t dim0_offset, const int *& type_pos, const T *& unpredictable_data_pos, T * dec_data_pos){
	T * cur_data_pos = dec_data_pos;
	T * buffer_pos = buffer + buffer_dim0_offset + 1;
	for(int i=0; i<size_x; i++){
...
template<typename T>
inline void
block_pred_and_decompress_lorenzo_2d_with_eb(const meanInfo<T>& mean_info, T * buffer, const double * precision_pos, int intv_radius, 
	int size_x, int size_y, size_t buffer_dim0_offset, size_t dim0_offset, const int *& type_pos, const T *& unpredictable_data_pos, T * dec_data_pos){
	T * cur_data_pos = dec_data_pos;
	T * buffer_pos = buffer + buffer_dim0_offset + 1;
	for(int i=0; i<size_x; i++){
...
template<typename T>
inline void
block_pred_and_decompress_lorenzo_3d_with_eb(const meanInfo<T>& mean_info, T * buffer, const double * precision_pos, int intv_radius, 
	int size_x, int size_y, int size_z, size_t buffer_dim0_offset, size_t buffer_dim1_offset, size_t dim0_offset, size_t dim1_offset, 
	const int *& type_pos, const T *& unpredictable_data_pos, T * dec_data_pos){
	T * cur_data_pos = dec_data_pos;
	T * buffer_pos = buffer + buffer_dim0_offset + buffer_dim1_offset + 1;
