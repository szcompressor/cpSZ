...
int main(int argc, char ** argv){
    ...
    // unsigned char * result =  sz_compress_2d(data, r1*r2, r3, eb*(max - min), result_size);
    unsigned char * result =  sz_compress_2d_pwr(data, r1*r2, r3, eb, result_size);
    ...
    // float * dec_data = sz_decompress_2d<float>(result, r1*r2, r3);
    float * dec_data = sz_decompress_2d_pwr<float>(result, r1*r2, r3);
    err = clock_gettime(CLOCK_REALTIME, &end);
